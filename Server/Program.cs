...
namespace Server
{
    class Program
    {
        ...
        static async Task SendPassword()
        {
            ...
            emailMessage.From.Add(new MailboxAddress($"RubickTanks", AdminEmail.Email));
            emailMessage.To.Add(new MailboxAddress($"Hello - {user.Login}", user.Email));
            ...
            using (var client = new SmtpClient())
            {
                ...
                await client.AuthenticateAsync(AdminEmail.Email, AdminEmail.Pass);
